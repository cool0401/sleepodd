...
namespace Podcast.Infrastructure.Migrations
{
    ...
    [Migration("20240712073752_UpdateShow")]
            ...
            modelBuilder.Entity("Podcast.Infrastructure.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("61c20a30-ae33-43aa-9154-85b98f031de2"),
                            ConcurrencyStamp = "8d0e8b0f-de2b-41e0-a9e2-611e204d3153",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = new Guid("40c4004a-a269-48ec-b889-9d635434ee93"),
                            ConcurrencyStamp = "7e2480f1-1bba-4dd5-8ae0-5b383339e1b3",
                            Name = "Admin",
