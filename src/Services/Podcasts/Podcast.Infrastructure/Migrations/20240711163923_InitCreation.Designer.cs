...
namespace Podcast.Infrastructure.Migrations
{
    ...
    [Migration("20240711163923_InitCreation")]
            ...
            modelBuilder.Entity("Podcast.Infrastructure.Data.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6ad5b041-7132-49d8-984a-b52d2d759fad"),
                            ConcurrencyStamp = "ce939416-c4c0-49cd-84d1-e5bac8aad7ce",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = new Guid("a94ba140-3848-40b4-bc52-05853a2c1df9"),
                            ConcurrencyStamp = "b692c4e9-2f90-48c0-bfda-77ad885b9b98",
                            Name = "Admin",
