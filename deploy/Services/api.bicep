...
resource sqlFirewallRule 'Microsoft.Sql/servers/firewallRules@2023-05-01-preview' = if (true) {
  parent: sqlServer
...
resource ingestionContainerApp 'Microsoft.App/containerApps@2023-04-01-preview' = if (deployIngestion) {
...
resource updaterContainerApp 'Microsoft.App/containerApps@2023-04-01-preview' = {
  name: updaterName
  location: location
  properties: {
    managedEnvironmentId: kubernetesEnvId
